...
const Home = () => {
  ...
  return (
    <PageLayout>
      <Typography variant="h4" color="black" component="div" align="center">
        Welcome to SWAPI
      </Typography>
      {isAuthenticated ? (
        <Typography variant="h6" color="green" component="div" align="center">
          You are logged.
        </Typography>
      ) : (
        <Box
        ...
        >
          <ButtonGroup fullWidth size="large" aria-label="Large button group">
            <Button
              key="one"
              variant={entry === Entry.LOGIN ? "contained" : "outlined"}
            ...
            <Button
              key="two"
              variant={entry === Entry.REGISTER ? "contained" : "outlined"}
